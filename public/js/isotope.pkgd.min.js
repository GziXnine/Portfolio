...
((e, i) => {
            ...
            (e = this).each(function (t, e) {
              ...
              e
                ? (i = e[o]) && "_" != o.charAt(0)
                  ...
                  : m(r + " is not a valid method")
                : m(h + " not initialized. Cannot call methods, i.e. " + r);
            }),
            void 0 !== s ? s : e)
          : ((a = t),
    ...
    function v(t) {
      if (
        ...
        var u = n.paddingLeft + n.paddingRight,
          ...
          f = s && _,
          p = y(e.width),
          p = (!1 !== p && (n.width = p + (f ? 0 : u + m)), y(e.height));
        return (
          !1 !== p && (n.height = p + (f ? 0 : d + c)),
          (n.innerWidth = n.width - (u + m)),
          (n.innerHeight = n.height - (d + c)),
            ...
            : ((this.stagger =
                "number" == typeof (e = e)
                  ...
                  : ((t = (e = e.match(/(^\d*\.?\d*)(\w*)/)) && e[1]),
                    (e = e && e[2]),
                    t.length ? (t = parseFloat(t)) * (c[e] || 1) : 0)),
              this.stagger);
        }),
        ...
        (m.dispatchEvent = function (t, e, i) {
          ...
          this.emitEvent(t, o),
            u &&
              ...
              e
                ? (((o = u.Event(e)).type = t), this.$element.trigger(o, i))
  ...
  ((r, a) => {
    ...
    var a = t.jQuery,
      ...
      t = ((u.Item = n), (u.LayoutMode = r), u.prototype),
      d =
        ((t._create = function () {
        ...
        (t._filter = function (t) {
          for (
            ...
            h.isIgnored ||
              ((a = s(h)) && i.push(h),
              a && h.isHidden ? o.push(h) : a || h.isHidden || n.push(h));
          }
